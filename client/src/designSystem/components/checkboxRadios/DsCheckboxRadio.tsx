    ...
    <>
      {
        ...
        type === 'checkbox' ?
          ...
          <Form.Item name={name} label="" className={`form-item form-item-${size || 'md'} ${wrapperClassName}`} valuePropName="checked" rules={rules}>
          ...
          :
          /* radios */
          <div className={`form-item form-item-${radioLabelSize || 'md'} ${wrapperClassName}`}>
            {
              radioLabel &&
              <FormItemLabel
                text={radioLabel}
